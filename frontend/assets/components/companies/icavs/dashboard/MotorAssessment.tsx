            ...
            <div className="mb-6 flex flex-col md:flex-row md:items-center md:justify-between">
              ...
              <div className="mt-4 md:mt-0">
                <div className="flex items-center space-x-2">
                  <label htmlFor="reportStatus" className="text-sm font-medium text-gray-700">Status:</label>
                  <select
                    id="reportStatus"
                    value={reportStatus}
...
+                    disabled={isUpdatingStatus}
                    className={`px-3 py-2 border rounded-md text-sm font-medium ${
                      ...
                      reportStatus === 'cancelled' ? 'bg-red-50 text-red-800 border-red-300' :
          ...
          {showCancelDialog && (
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
              <div className="bg-white rounded-lg p-6 max-w-md w-full">
                <h3 className="text-lg font-medium text-gray-900 mb-4">Cancellation Reason</h3>
                <p className="text-sm text-gray-600 mb-4">Please provide a reason for cancelling this report.</p>
                <textarea
                  value={cancelReason}
