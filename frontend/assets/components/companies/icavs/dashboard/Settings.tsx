...
+import { UserPlus, Trash2, Eye, EyeOff, Building, Phone, Mail, MapPin, Save } from 'lucide-react';
...
+                  <h3 className="font-medium text-blue-800 mb-2">Current Plan</h3>
+                  <div className="flex justify-between items-center">
+                    <div>
+                      <p className="text-2xl font-bold text-blue-900">Standard</p>
...
+                        <tr>
+                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">July 1, 2025</td>
+                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">$4,000.00</td>
...
+                        </tr>
+                        <tr>
+                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">June 1, 2025</td>
+                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">$4,000.00</td>
+                          <td className="px-6 py-4 whitespace-nowrap">
+                            <span className="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">Paid</span>
+                          </td>
...
+                    <p className="text-sm text-gray-500">Receive notifications when report status changes</p>
+                  </div>
...
+                    <p className="text-sm text-gray-500">Receive notifications when new users are added</p>
+                  </div>
+                  <label className="relative inline-flex items-center cursor-pointer">
+                    <input type="checkbox" className="sr-only peer" defaultChecked />
+                    <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
